// Admin Page That is used at the backend data
// Currently won't be of use as the keys have been removed
const app = new Vue({
  el: "#app",
  data: {
  ...
  methods: {
    initialize() {
      ...
      firebase
        ...
        .on("value", this.dataChanged, this.firebaseError);
    },
    dataChanged(data) {
      // Reloads company data if it is updated in the database
      let obj = data.val();
